...
public class V2_Flags extends Activity {
...
//        new Thread(readThread).start();
    ...
    Runnable readThread = new Runnable() {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    Log.e(TAG + "---ready", String.valueOf(mytest));
                    String SendResponse = DocHessianServiceTest.sendHttpPost(myUrl, mytest.toString());
                    Log.e(TAG + "---send", String.valueOf(mytest));
                    Log.e(TAG + "---receive", String.valueOf(SendResponse));
